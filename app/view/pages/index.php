<!-- Import Header -->
<?php require(realpath(dirname(__FILE__) . '/..') . '/layout/header.php'); ?>


<!-- Import Navbar -->
<?php require(realpath(dirname(__FILE__) . '/..') . '/layout/navbar_login.php');?>
...
<!-- Import Footer -->
<?php require(realpath(dirname(__FILE__) . '/..') . '/layout/footer.php');?>
