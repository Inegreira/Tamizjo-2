        ...
        <div class="col-md-4 col-sm-12">
            <form action="<?=URLROOT;?>/teachers/addTeacher" method="POST">
                ...
                <div class="d-flex mb-2">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Indica el nombre del profesor">
                </div>
                <div class="form-group">
                <div class="d-flex mb-2">
                        <label for="color">Apellido</label>
                    </div>
                    <input type="text" class="form-control" name="surname" placeholder="Indica el apellido del profesor">
                </div>
                <div class="form-group">
                <div class="d-flex mb-2">
                        <label for="color">Teléfono</label>
                    </div>
                    <input type="text" class="form-control" name="telephone" placeholder="Indica el teléfono del profesor">
                </div>
                <div class="form-group">
                <div class="d-flex mb-2">
                        <label for="color">NIF</label>
                    </div>
                    <input type="text" class="form-control" name="nif" placeholder="Indica el NIF del profesor">
                </div>
                <div class="form-group">
                <div class="d-flex mb-2">
